...
import { useAcademicChapterStatistics } from "@workspace/api-client";

interface StatisticsTabProps {
  chapterId: string;
}

export const StatisticsTab = ({ chapterId }: StatisticsTabProps) => {
  const { data, isLoading } = useAcademicChapterStatistics(chapterId);
  ...
  const { contentDistribution, hierarchy, questionBank } = data;
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription className="text-[10px] font-bold uppercase tracking-widest opacity-70">
                  Weightage of topics in this chapter
                </CardDescription>
              </div>
            </div>
          </CardHeader>
                ...
                <div key={topic.id} className="space-y-2 group">
                  <div className="flex justify-between items-end">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60 bg-muted/50 px-2 py-0.5 rounded-lg border border-border/50">
                      {topic.subtopics} sub-topics ({topic.percentage}%)
                    </span>
                  </div>
                  <Progress
          ...
          <CardHeader className="pb-6 bg-muted/30 border-b border-border/50">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription className="text-[10px] font-bold uppercase tracking-widest opacity-70">
                  Detailed distribution of items in this chapter
                </CardDescription>
              </div>
            </div>
          </CardHeader>
