import { ChevronRight, Plus, Layers, HelpCircle } from "lucide-react";
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription className="text-[10px] font-bold uppercase tracking-widest opacity-70">
                Full list of topics in {chapterName}
              </CardDescription>
            </div>
          </div>
          <Button
          ...
          {topics.length === 0 ? (
            <div className="text-center py-20 bg-muted/20 rounded-3xl border-2 border-dashed border-border/50">
              ...
              <p className="text-sm text-muted-foreground mb-8 max-w-xs mx-auto font-medium">
                Your educational framework is currently empty. Start building it
                out by adding your first topic.
              </p>
              <Button
                asChild
                size="lg"
